...
import { BadgeLibraryModal, PrintBadgeSection, BADGE_TEMPLATES } from './BadgeLibrary';
              ...
              <div className="absolute inset-0 bg-[#1c1c1e] rounded-[28px] shadow-2xl p-[14px]">
                <div className="w-full h-full rounded-[18px] overflow-hidden flex flex-col relative"
                  ...
                  <div className="relative z-10 flex items-center justify-between px-5 py-2 bg-black/10">
                    ...
                    {/* QR placeholder - actual QR shows on real tablet */}
                      ...
                      <div className="bg-white rounded-lg p-1.5 flex flex-col items-center gap-0.5 shadow-sm">
                        <div className="w-12 h-12 bg-slate-100 rounded flex items-center justify-center">
                          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="2">
                            ...
                            <rect x="3" y="14" width="7" height="7"/><rect x="5" y="5" width="3" height="3" fill="#64748b" stroke="none"/>
                            <rect x="16" y="5" width="3" height="3" fill="#64748b" stroke="none"/>
                            <rect x="5" y="16" width="3" height="3" fill="#64748b" stroke="none"/>
                          </svg>
                        </div>
